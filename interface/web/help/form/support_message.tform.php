	...
	'fields'  => array (
		...
		'recipient_id' => array (
			...
			'datasource' => array (  'type'   => 'SQL',
				'querystring'  => "SELECT sys_user.userid, {CLIENTNAMESQL} as contactname FROM sys_user, client WHERE sys_user.userid != 1 AND sys_user.client_id = client.client_id AND $authsql ORDER BY sys_user.username",
				'keyfield'  => 'userid',
